			...
			<tr>
				<th>
					<table width="100%" cellspacing="0">
						<tr>
							<th colspan="10" style="border-bottom: 1px solid;background-color: #28FCE1;padding: 5px 0px;font-size: 45px;">Students Records</th>
						</tr>
						<tr>
						...
						<?php
						$sql = "SELECT * FROM records where teacher_number = '".$_SESSION["id"]."' order by lastname ASC";
